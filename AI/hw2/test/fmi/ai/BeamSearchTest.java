...
public class BeamSearchTest {
    ...
    public void shouldReturn0ForSolvedPuzzle() {
        ...
        assertEquals(0, BeamSearch.findShortestPath(boardState, 2));
    }
    ...
    public void shouldFindShortestPathSimple() {
        ...
        assertEquals(2, BeamSearch.findShortestPath(boardState, 2));
    }
    ...
    public void shouldFindShortestPathMedium() {
        ...
        assertEquals(8, BeamSearch.findShortestPath(boardState, 2));
    }
    ...
    public void shouldReturnShortestPathHard() {
        ...
        assertEquals(7, BeamSearch.findShortestPath(boardState, 2));
    }
    ...
    public void shouldReturnShortestPathExample() {
        ...
        assertEquals(21, BeamSearch.findShortestPath(boardState, 2));
    }
